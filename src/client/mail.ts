...
export default class Mail {
    ...
    public addMailServers(servers: mail.AddMailServerInfoType[]): Promise<mail.MailServerInfoType[]> {
        const parameters: Object[] = [];
        ...
        return this.client.post(this.path, 'MailAddMailServers', parameters).then((res: mail.ServersResponse) => {
